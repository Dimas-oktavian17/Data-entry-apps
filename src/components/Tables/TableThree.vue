...
const { RealData,
  ...
  StatusEmployes,
  AgeMinInput,
  AgeMaxInput } = storeToRefs(StorePaggination)
...
<template>
  <div
    ...
    <header
      ...
      <FormKit v-model="AgeMinInput" type="number" name="name" label="Minimal Age" placeholder="0"
        validation="required|length:1" :classes="{
          outer: 'mb-4.5 w-full xl:w-1/2',
          label:
            'mb-2.5 block text-black dark:text-white',
          inner: ' focus:outline-1',
      ...
      <FormKit v-model="AgeMaxInput" type="number" name="name" label="Maximal Age" placeholder="10"
        validation="required|length:1" :classes="{
          outer: 'mb-4.5 w-full xl:w-1/2',
          label:
            'mb-2.5 block text-black dark:text-white',
