...
const fetchCities = async () => {
 ...
 try {
  const { data } = await axios.get(`https://www.emsifa.com/api-wilayah-indonesia/api/districts/${selectedProvince.value}.json`)
  cities.value = data
 } catch (error) {
  console.error(error);
 }
...
const fetchDistricts = async () => {
 ...
 try {
  const { data } = await axios.get(`https://www.emsifa.com/api-wilayah-indonesia/api/districts/${selectedCity.value}.json`)
...
const fetchVillages = async () => {
 ...
 try {
  const { data } = await axios.get(`https://www.emsifa.com/api-wilayah-indonesia/api/villages/${selectedDistrict.value}.json`)
